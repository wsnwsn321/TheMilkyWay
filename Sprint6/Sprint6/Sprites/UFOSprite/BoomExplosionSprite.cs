...
{
    public class BoomExplosionSprite : ISprite

    {
        ...
        private Vector2 circleCenter1, circleCenter2, circleCenter3;
        private int counter;
        Vector2 p;


        public BoomExplosionSprite(Texture2D texture,SpriteBatch sb, int currentF)
        {
            Texture = texture;
            this.sb = sb;
            totalColumn = 5;
        ...
        {
            sb.Begin();
            Rectangle sourceRectangle = new Rectangle(64 * currentRow, 64*currentColumn, 64, 64);
